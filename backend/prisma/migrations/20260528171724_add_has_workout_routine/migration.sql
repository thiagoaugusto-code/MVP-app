...
CREATE TABLE "new_DailyUserState" (
    ...
    "hasWorkoutRoutine" BOOLEAN NOT NULL DEFAULT false,
    "exercises" TEXT,
    "completedWorkoutIds" TEXT,
    "mealsSnapshot" TEXT,
    "checklist" TEXT,
...
INSERT INTO "new_DailyUserState" ("calendarStatus", "caloriesConsumed", "caloriesGoal", "checklist", "completedWorkoutIds", "createdAt", "date", "exercises", "id", "mealsGoal", "mealsSnapshot", "progressScore", "sessions", "sleepHours", "updatedAt", "userId", "waterGoalMl", "waterMl", "workoutCompleted", "workoutGoal") SELECT "calendarStatus", "caloriesConsumed", "caloriesGoal", "checklist", "completedWorkoutIds", "createdAt", "date", "exercises", "id", "mealsGoal", "mealsSnapshot", "progressScore", "sessions", "sleepHours", "updatedAt", "userId", "waterGoalMl", "waterMl", "workoutCompleted", "workoutGoal" FROM "DailyUserState";
